...
function Application() {
    ...
    const getData = async () => {
        ...
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/jobprovider/getapplication/${location.state}`, {
            method: 'POST',
            headers: {
    ...
    const handleHire = async (e, id) => {
        ...
        if (result) {
            const response = await fetch(process.env.REACT_APP_BACKEND_URL + "/api/application/change", {
                method: 'POST',
                headers: {
    ...
    const handleNext = async (e, id) => {
        ...
        if (result) {
            const response = await fetch(process.env.REACT_APP_BACKEND_URL + "/api/application/change/sendnext", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'auth-token': localStorage.getItem('token')
